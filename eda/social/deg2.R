...
nodes = read.csv("/home/flathers/Desktop/workspace/search-log-analysis/eda/social/deg2nodes.csv", header=TRUE, as.is=TRUE)
links = read.csv("/home/flathers/Desktop/workspace/search-log-analysis/eda/social/deg2edges.csv", header=TRUE, as.is=TRUE)
...
plot(net, layout=layout_in_circle, 
     ...
     edge.width=E(net)$weight/2, edge.color="black",
